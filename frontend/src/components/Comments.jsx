      ...
      <div className="space-y-4">
        <div className="flex" key={comments._id}>
          ...
          <div className="flex-1 border rounded-lg px-4 py-2 sm:px-6 sm:py-4 ">
            ...
            {userLogin ? <div className='text-comments'>
              <span onClick={() => setIsShowing((isShowing) => !isShowing)} onInput={(event) => setEditComment(event.currentTarget.textContent)} suppressContentEditableWarning={true} contentEditable><strong>{comments?.comment}</strong></span>

            </div> : <div className='text-comments'>
            ...
            {userLogin ? <div className="flex justify-end">
