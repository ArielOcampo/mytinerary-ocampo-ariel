  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage: `url(https://i.imgur.com/9SU1sGt.jpg)`,
      ...
      >
        <div
          className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden rounded-xl border bg-opacity-50 backdrop-blur-2xl bg-white shadow-xl"
                ...
                <form onSubmit={handleSubmit}>
                  <div className="flex -mx-3">
                    ...
                    <div className="w-1/2 px-3 mb-5">
                      ...
                      <div className="flex">
                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex flex-wrap items-center justify-center">
                          <i className="mdi mdi-account-outline text-gray-400 text-lg"></i>
                        </div>
                        <input
                          type="text"
