  ...
  return (
    <footer className="footer-styles  bg-white  dark:bg-gray-800">
      <div className="md:flex md:justify-between items-center pt-3">
        ...
        <div className="flex lg:flex-col justify-center mx-10 ">
          <div>
            <h2 className="mb-2 text-lg  font-semibold  uppercase text-white">Navigation</h2>
      ...
      <hr className="my-2 border-gray-200 lg:mx-auto border-gray-500  mx-8  " />
