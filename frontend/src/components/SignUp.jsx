...
function SignUp() {
  ...
  // const notifications = useSelector(store => store.userReducer.notification)
  ...
  return (
    <>
      ...
      <div className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5" style={{ backgroundImage: `url(${Fondo})` }}>
