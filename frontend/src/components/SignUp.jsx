...
function SignUp() {
  ...
  return (
    <>
      ...
      <div className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5" style={{ backgroundImage: `url(https://i.imgur.com/9SU1sGt.jpg)`, backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed" }}>
        <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden rounded-xl border bg-opacity-50 backdrop-blur-2xl bg-white shadow-xl" style={{ maxWidth: "1000px" }}>
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10 ">
              <div className="text-center mb-10">
                ...
                <p tabIndex={0} className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">
                  ...
                  <LinkRouter to='/login' className="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none text-gray-800 cursor-pointer">
                    {" "}
                    Log in here
                  </LinkRouter>
                </p>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="flex -mx-3" >
                    ...
                    <div className="w-1/2 px-3 mb-5">
                      ...
                      <div className="flex">
                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex flex-wrap items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-7">
                      <label htmlFor="" className="text-xs font-semibold px-1">User photo</label>
                      <div className="flex">
                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                        <input type="text" name="userPhoto" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Url Image" />
                      </div>
                    </div>
                  </div>
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-7">
                      ...
                      <div className="flex">
                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                        <select type="select" name="country" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Country" >
