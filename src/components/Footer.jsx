...
export default function footer () {
  return (
<footer className="footer-styles p-5 bg-white sm:p-7 dark:bg-gray-800">
<div className="md:flex md:justify-between">
<div className="mb-6 md:mb-0">
<div  className="flex mx-10 justify-center">
<img src={Logo} className="mr-3 h-16" alt="Mytinerary Logo"/>
<span className="text-footer self-center text-2xl font-semibold whitespace-nowrap text-white">Mytinerary</span>
</div>
</div>
<div className="flex gap-8 sm:gap-6  lg:flex-col justify-center mx-10">
<div>
...
<hr className="my-6 border-gray-200 sm:mx-auto border-gray-500 lg:my-8"/>
<div className="sm:flex sm:items-center sm:justify-between">

<div className="flex flex mx-10 justify-center mt-4 space-x-6 sm:justify-center sm:mt-0">
<LinkRouter to="#"  className="text-gray-500 hover:text-white dark:hover:text-white">
<svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path  d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" ></path></svg>
</LinkRouter>
<LinkRouter to="#"  className="text-gray-500 hover:text-white dark:hover:text-white">
